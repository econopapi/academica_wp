...
<?php } else if (strpos($user_email, 'xoc.uam.mx') !== false) { ?>
    ...
    <?php
    $docente_request = 'http://academica.dlimon.net/historial_academico/docentes?email=' . $user_email;
    $docente_response = wp_remote_get($docente_request);

    $trimestre_request = 'http://academica.dlimon.net/historial_academico/trimestre_actual';
    ...
    $asignacion_request = 'http://academica.dlimon.net/historial_academico/asignacion_por_docente?numero_economico='.$numero_economico.'&trimestre='.$trimestre;
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $trimestre_response_json['payload']['trimestre']; ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
