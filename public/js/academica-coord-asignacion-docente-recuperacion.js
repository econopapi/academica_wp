document.getElementById('asignacion_docente_form').addEventListener('submit', function(event) {
    ...
    fetch(`https://academica.dlimon.net/historial_academico/asignacion_por_docente?recuperacion=true&trimestre=${trimestre}&numero_economico=${numero_economico}&detalle=true`)
