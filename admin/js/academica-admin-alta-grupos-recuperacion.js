...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    selectModulo.addEventListener('change', function() {
        ...
        fetch(`${academicaApiConfig.apiUrl}/coordinacion/recuperacion/grupos?modulo=${moduloSeleccionado}`)
    ...
    async function fetchGrupos(trimestre) {
        try {
            ...
            const response = await fetch(`${academicaApiConfig.apiUrl}/historial_academico/grupos_por_trimestre?trimestre=${trimestre}&recuperacion=true`);
    ...
    function populateTable(grupos) {
        ...
        grupos.forEach(grupo => {
            ...
            grupoCell.textContent = grupo.grupo.grupo;
            ...
            detallesButton.setAttribute('data-grupo', grupo.grupo.grupo);
            detallesButton.setAttribute('data-trimestre', trimestre.value);
            detallesButton.setAttribute('data-modulo', grupo.uea.modulo);
        ...
        detalleButtons.forEach(button => {
            button.addEventListener('click', async function() {
                ...
                try {
                    const response = await fetch(`${academicaApiConfig.apiUrl}/historial_academico/seguimiento_recuperacion?trimestre=${trimestre}&grupo=${grupo}&modulo=${modulo}&detalle=true`);
                    const data = await response.json();
                ...
                document.getElementById('delete-group-button').addEventListener('click', async function() {
                    ...
                    if (confirm('¿Estás seguro de que deseas eliminar este grupo?')) {
                        try {
                            ...
                            const deleteResponse = await fetch(`${academicaApiConfig.apiUrl}/coordinacion/recuperacion/grupos`, {
                                method: 'DELETE',
                                headers: {
    ...
    asignacionForm.addEventListener('submit', function(event) {
        ...
        reader.onload = function(e) {
            ...
            fetch(`${academicaApiConfig.apiUrl}/coordinacion/recuperacion/grupos`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
